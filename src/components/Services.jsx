    ...
    return (
        <section ref={containerRef} className="w-full relative py-35 px-2">
            <div className="flex flex-col w-full items-center gap-10">
                <div ref={titleSectionRef} className="flex gap-2 items-center text-center font-bold px-4 py-2 bg-black text-white rounded-xl select-none whitespace-nowrap">
